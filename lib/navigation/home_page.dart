...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Song Lyrics Display'),
        backgroundColor: const Color.fromARGB(255, 153, 43, 16),
      ),
body: Container(
  decoration: BoxDecoration(
    // Use an image as the background
    image: DecorationImage(
      image: AssetImage('assets/Music-Core-Wallpaper.jpg'),// <- your image path
  ...
  child: ListView.builder(
    ...
    itemBuilder: (context, index) {
      ...
      return Card(
        ...
        color: const Color.fromARGB(255, 218, 218, 218), // semi-transparent card to show background
        child: ListTile(
          leading: const Icon(Icons.music_note, color: Color.fromARGB(255, 146, 15, 15)),
